...
render(){
    ...
    <Container>
        ...
        <Content style={{backgroundColor:'#333333'}} >
            ...
            <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Trailers&Extras</Text>
            <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('trailerExtras')} />
            </View>     
