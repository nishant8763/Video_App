...
return (
    <Container>
        <Header style={{backgroundColor:'#000'}} >
            ...
            <Body  >           
                <Text style={{color:'#fff', fontSize:22, fontWeight:'bold'}}>Seasons</Text>
            </Body>
        </Header>
        <Content style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}} >
            ...
            renderItem={({item}) =>{
            return(
            <TouchableOpacity style={{paddingHorizontal:5,paddingHorizontal:5, marginEnd:10, borderRadius:40, marginBottom:10}} onPress={()=>this.props.navigation.navigate('seasonsDetails', {item})}>
                <ImageBackground style={{ height:150, width:190, borderRadius:40,}}
                    source={{ uri:item.image}}>
                    <View style={{ flexDirection:'row', top:120, paddingHorizontal:10 , }} >
