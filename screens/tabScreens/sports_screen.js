    ...
    <Container>
        ...
        <Content  style={styles.container} >
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
                ...
                <Text style={{fontSize:18, fontWeight:'bold' ,color:'red'}} >Live</Text>
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
            <View style={{flexDirection:'row', justifyContent:'space-between',}} >
            <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Trending Videos</Text>
            <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
            </View>     
            <FlatList style={{elevation:20}}
            contentContainerStyle={{ paddingVertical:10, }}
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
            <View style={{flexDirection:'row', justifyContent:'space-between',}} >
            <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Highlights</Text>
            <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
            </View>     
            <FlatList style={{elevation:20}}
            contentContainerStyle={{ paddingVertical:10, }}
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Best Of Cricket</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
        </View>     
        <FlatList style={{elevation:20}}
        contentContainerStyle={{ paddingVertical:10, }}
        ...
        <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Sports News</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
        </View>     
        <FlatList style={{elevation:20}}
        contentContainerStyle={{ paddingVertical:10, }}
