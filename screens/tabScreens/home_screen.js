...
import {View, Text, StyleSheet,ScrollView, Image, Modal, SafeAreaView,TouchableHighlight,FlatList, TouchableOpacity  } from "react-native";
...
<Content style={styles.container}>       
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          ...
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('popularMovies')}  />
        </View>     
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Popular Shows</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('PopularShows')} />
        </View>     
        <FlatList style={{elevation:20}}
        contentContainerStyle={{ paddingVertical:10, }}
          horizontal
        ...
        renderItem={({item}) =>{
        return(
          <TouchableOpacity style={{ elevation:2}} onPress={()=>this.props.navigation.navigate('showDetails')} >
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Trending Movies</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('popularMovies')} />
        </View>
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Multiplex Movies</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('popularMovies')} />
        </View>
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Popular Songs</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('popularMovies')}  />
        </View>
        ...
        return(
          <TouchableOpacity>
          <Image style={{paddingHorizontal:5, height:200, width:150, marginEnd:20}}
          source={{ uri:item.image}} />
          </TouchableOpacity>                      
        );}}
        />
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Web Series</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('popularMovies')} />
        </View>    
        <FlatList style={{}}
        contentContainerStyle={{ paddingVertical:10}}
      ...
      <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Sports</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}} onPress={()=>this.props.navigation.navigate('popularMovies')} />
        </View>
