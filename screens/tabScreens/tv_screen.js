    ...
    <Container>
        ...
        <Content  style={styles.container} >
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
                ...
                <Text style={{fontSize:18, fontWeight:'bold' ,color:'red'}} >Live Channels</Text>
                ...
                <Image style={{paddingHorizontal:5, height:120, width:120, marginEnd:20, borderRadius:70, borderWidth:2, borderColor:'red' }}
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
            <View style={{flexDirection:'row', justifyContent:'space-between',}} >
            <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >English Shows</Text>
            <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
            </View>     
            <FlatList style={{elevation:20}}
            contentContainerStyle={{ paddingVertical:10, }}
            ...
            <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Hindi Shows</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
        </View>     
        <FlatList style={{elevation:20}}
        contentContainerStyle={{ paddingVertical:10, }}
        ...
        <View style={{marginTop:15 ,paddingHorizontal:10, paddingVertical:5, backgroundColor:'#000'}}>
        <View style={{flexDirection:'row', justifyContent:'space-between',}} >
          <Text style={{fontSize:18, fontWeight:'bold' ,color:'#fff'}} >Other Languages</Text>
          <Icon type='FontAwesome' name='chevron-right' style={{ fontSize:20, color:'#fff'}}  />
        </View>     
        <FlatList style={{elevation:20}}
        contentContainerStyle={{ paddingVertical:10, }}
